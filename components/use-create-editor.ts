...
import { copilotPlugins } from "@/components/copilot-plugins";
import { editorPlugins } from "@/components/editor-plugins";
import { FixedToolbarPlugin } from "@/components/fixed-toolbar-plugin";
import { FloatingToolbarPlugin } from "@/components/floating-toolbar-plugin";
...
export const useCreateEditor = (
  {
    ...
    placeholders,
    readOnly,
    yjsOptions, // Accept Yjs options (ydoc, awareness, providers, etc.)
    ...options
  }: {
  ...
  // Conditionally add YjsPlugin if yjsOptions are provided
  const plugins = [
    ...copilotPlugins,
    ...editorPlugins,
    FixedToolbarPlugin,
